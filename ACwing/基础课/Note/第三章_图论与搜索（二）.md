...
- 单源最短路
- 多源汇最短路
![](/ACwing/%E5%9F%BA%E7%A1%80%E8%AF%BE/Note/pictures/Snipaste_2022-12-14_10-16-02.jpg)
...
2. 循环n次：
    每次从距离已知的点中，选取一个不在**s**集合中，且**距离最短**的点**t**（这一步可以用小根堆来优化），把**t**加入到集合**s**中，遍历**t**的所有出边，更新这些出边所连接的点的距离。
